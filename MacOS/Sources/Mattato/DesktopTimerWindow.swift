...
struct DesktopTimerView: View {
        ...
        ZStack {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: size * 0.12)
                    .stroke(Color(red: 0.55, green: 0.15, blue: 0.15).opacity(0.8), lineWidth: 3)
            )
            .frame(maxWidth: size * 0.85 + 20, maxHeight: size * 0.4 + 40)
            .onTapGesture {
            }
        }
    ...
    var body: some View {
        ZStack {
            if let timerImage = loadTimerImage() {
            ...
            ZStack {
                Text(safeFormattedTime)
                    .font(.system(size: size * 0.139, weight: .bold, design: .monospaced))
                    .foregroundColor(.white)
                    .offset(y: size * -0.09)
    ...
    private func loadTimerImage() -> NSImage? {
        let possiblePaths = [
            Bundle.main.url(forResource: "tomato-desktop", withExtension: "png"),
            Bundle.main.url(forResource: "tomato-desktop", withExtension: "png", subdirectory: "Resources"),
            Bundle.main.resourceURL?.appendingPathComponent("tomato-desktop.png"),
            Bundle.main.resourceURL?.appendingPathComponent("Resources/tomato-desktop.png")
        ]
        ...
        let sourceURL = URL(fileURLWithPath: "/Users/matthew.reider/mattato/MacOS/Sources/Mattato/Resources/tomato-desktop.png")
