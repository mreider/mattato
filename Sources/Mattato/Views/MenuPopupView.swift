...
struct MenuPopupView: View {
    ...
    private func showCustomerManager() {
        ...
        customerWindow.contentView = NSHostingView(rootView: CustomerManagerView(historyManager: historyManager))
    ...
    private func showProjectManager() {
        ...
        projectWindow.contentView = NSHostingView(rootView: ProjectManagerView(historyManager: historyManager))
    ...
    private func showSessionHistoryWindow() {
        ...
        historyWindow.contentView = NSHostingView(rootView: SessionHistoryView(historyManager: historyManager))
