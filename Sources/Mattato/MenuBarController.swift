...
class MenuBarController: NSObject {
    ...
    private func updateStatusItemAppearance() {
        ...
        if let robotImage = loadRobotIcon() {
            button.image = robotImage
    ...
    */
    ...
    private func loadRobotIcon() -> NSImage? {
        guard let resourcePath = Bundle.main.path(forResource: "robot-head", ofType: "png"),
    ...
    */
    ...
    @objc private func showContextMenu() {
        ...
        let robotVisible = desktopTimerWindow?.isVisible ?? false
        let robotToggleTitle = robotVisible ? "Hide Timer" : "Show Timer"
        let robotToggleItem = NSMenuItem(title: robotToggleTitle, action: #selector(toggleTimerVisibility), keyEquivalent: "")
        robotToggleItem.target = self
        menu.addItem(robotToggleItem)
